...
<div>
  ...
  <div v-if="aboutToExpire.length > 0" class="bg-white rounded-3xl flex flex-col p-5 border-2 shadow shadow-warning border-warning gap-2">
    ...
    <div v-for="item in aboutToExpire" :key="item.id" class="flex gap-2 py-1 px-3 justify-between items-center w-full rounded-xl bg-neutral-100 mt-2">
      <div class="flex gap-1">
        ...
        <button 
          ...
          class="p-2 text-neutral-400 hover:text-red-500 hover:bg-red-100 rounded-full transition-colors"
        >
